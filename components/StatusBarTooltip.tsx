...
export function StatusBarTooltip({ performance, children, totalCalls }: StatusBarTooltipProps) {
  ...
  return (
    <div className="relative group/statustooltip">
      {children}
      <div className="absolute bottom-full right-0 mb-2 bg-white border border-[#e1e9f4] shadow-[0px_12px_24px_0px_rgba(18,38,63,0.1)] rounded-lg p-4 max-w-xs opacity-0 invisible group-hover/statustooltip:opacity-100 group-hover/statustooltip:visible transition-all duration-200 z-[9999]">
